...
src = "hdfs://172.18.0.8:9000/data/transformed/iowa_liquor/liquor_sales_transformed"
...
# Debug (jednom)
agg_rows = revenue_year.count()
print("Agg rows =", agg_rows)
revenue_year.show(50, False)
